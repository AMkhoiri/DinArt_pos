          ...
          <tr>
            ...
            <td style="width:15%">	
              @if ($o->status_produksi=="done" && $o->status_pengiriman==null)
               ...
               <a href="#" class="btn btn-sm btn-info disabled" data-toggle="tooltip" data-placement="top">Produksi</a>
              @else
                <a href="{{ route('admin-produksi-form',$o->id) }} " class="btn btn-sm btn-info " data-toggle="tooltip" data-placement="top" title="Update Proses produksi">Produksi</a>
...
$('body').on('click', '.btn-done', function(event) {
  ...
  Swal.fire({
      ...
      if (result.value) {  
        ...
        window.location.href = "{{ url('admin/produksi') }}"+'/'+id+'/kirim'
