  ...
  <div class="col-md-9"> --}}
    ...
    <div class="card-body">
        ...
        <div class="card-footer text-right ">
           ...
           <a href="{{ route('produksi-produksi-save',$order->id) }}" class="btn btn-sm btn-success pl-3 pr-3">Save Update <span class="fas fa-check ml-1" ></span></a>
...
<script>
   ...
   function checkItem(id) 
   {
      csrf_token= $('meta[name="csrf-token"]').attr('content') ;
         ...
         $.ajax({
            url:"{{ url('produksi/produksi/proses') }}"+'/'+id+'/check',
            type:"POST",
            data: {
                '_method':'POST',
                '_token':csrf_token 
