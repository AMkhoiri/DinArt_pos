  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light " style="box-shadow: 0px 0.5px 6px #999;">
    ...
    <ul class="navbar-nav ml-auto mr-2">
      ...
      <li class="nav-item dropdown">
        ...
        {{-- # --}}
        <span class="badge  font-weight-normal ml-0 pl-2 pr-2 pt-1 pb-1 d-inline" style="font-size: 12px; background-color: darkcyan ; color: white;"  > <i style="font-size: 12px;" class="fas fa-shield-alt" > Customer Service </i> </span> 
    ...
    <div class="user-panel ml-1 mt-0 pb-1 mb-1 d-flex">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('cs-databarang') }} " class="nav-link nav-linkk">
          ...
          <li class="nav-item">
            <a href=" {{ route('cs-transaksi') }}" class="nav-link nav-linkk">
